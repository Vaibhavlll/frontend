  ...
  return (
    <div className="flex flex-col h-dvh min-h-screen w-full text-slate-900 font-sans overflow-hidden bg-white">
      ...
      <main className="flex-1 relative overflow-hidden flex items-center justify-center">
        ...
        <ComingSoon
          description="We're building something amazing. Influencer Bot is being designed to analyze social media profiles, providing engagement rates, audience insights, and detailed performance metrics."
        />
      </main>
    </div>
  );
