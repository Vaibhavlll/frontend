...
// ─── Exported helper — shared with DashboardView ──────────────────────────────
// Detects whether a flow document should open in WaBotEditor vs EditorView.
//
// Handles all three possible shapes:
//   1. New flat WaBot (wa_bot_flows_{org_id}):
//        flow_type === "wabot"  OR  trigger_type/trigger_event/welcome_message at root
//   2. Old nested WaBot (automation_flows_{org_id}, pre-migration):
//        flow_data.trigger_event === "message_received"
//   3. EditorView flows: everything else
export function isWaBotFlow(flowData: any): boolean {
  if (!flowData) return false;

  // Shape 1 — flat WaBot fields at root (new wa_bot_flows collection)
