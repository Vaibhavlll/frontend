...
function GridOfBoxes() {
  ...
  // Use useMemo to generate boxes array to avoid recreating on each render
  const boxes = useMemo(() => {
    const boxArray = [];
    ...
    return boxArray;
  }, [gridSize, boxWidth, boxLength, spacingX, spacingZ, hoveredBox, rippleScale, rippleRadius]);
