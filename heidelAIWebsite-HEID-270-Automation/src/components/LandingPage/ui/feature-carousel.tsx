...
import { MessageCircle, Instagram, ShoppingBag, Globe } from 'lucide-react'
...
const steps: readonly Step[] = [
  {
    ...
    description: "Connect WhatsApp Business API for seamless customer communication with automated responses and rich media support.",
  ...
  },
  {
    ...
    description: "Integrate Instagram Direct Messages and Facebook Messenger to manage all social conversations in one unified platform.",
  ...
  },
  {
    ...
    description: "Sync your product catalogs from Shopify and WooCommerce for seamless product recommendations and sales automation.",
  ...
  },
  {
    ...
    description: "Build custom integrations with our flexible API to connect any platform or service to your AI communication hub.",
