...
export function HoverBorderGradient<T extends React.ElementType = "button">({
  ...
  return React.createElement(
    Tag,
    {
      ...
      className: cn(
        "relative flex rounded-full border-white/[0.1] hover:bg-black/10 transition duration-500 bg-white/20 items-center justify-center overflow-visible p-px w-fit",
        containerClassName
      ),
      ...props,
    },
